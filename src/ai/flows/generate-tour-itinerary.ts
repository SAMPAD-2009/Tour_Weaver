...
Instructions:
1.  **Destinations**: Generate a list of 3 to 5 top destinations to visit in {{location}}. For each destination, provide its name, a brief description, and a publicly accessible, high-quality image URL from Unsplash. Ensure the URLs are direct image links (images.unsplash.com) and are not prone to expiring.
